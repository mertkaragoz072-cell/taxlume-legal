export const STRINGS = {
  tr: {
    ...
    mentor: {
      ...
      buy: "Almak tek dokunuşla oluyor. Gerisini bulanıklaştırdım; şimdilik yalnızca o buton çalışıyor.",
      ...
      handoff: "Ekranın üstündeki İlk Adımlar sana tek tek yol gösterecek. Ben buralardayım.",
  ...
  en: {
    ...
    mentor: {
      ...
      buy: "Buying is one tap. I've blurred the rest — only that button works for now.",
      buyTip: "Press BUY.",
