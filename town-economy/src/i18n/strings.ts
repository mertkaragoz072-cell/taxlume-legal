  ...
  tr: {
    ...
    town: {
      ...
      bank: {
        ...
        ratePreview: "Bu vade için güncel oran: %{pct}/tur",
        cap: "Maks. kredi: {amount} 🪙",
        takeBtn: "{amount} 🪙 Çek",
        activeTitle: "Kalan Borç",
        rate: "%{pct}/tur faiz · {months} ay vade",
        repayBtn: "{amount} 🪙 Öde",
  ...
  en: {
    ...
    town: {
      ...
      bank: {
        ...
        ratePreview: "Current rate for this term: {pct}%/turn",
        cap: "Max loan: {amount} 🪙",
        takeBtn: "Borrow {amount} 🪙",
        activeTitle: "Outstanding Balance",
        rate: "{pct}%/turn interest · {months}mo term",
