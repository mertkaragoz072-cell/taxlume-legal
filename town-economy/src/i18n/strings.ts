  ...
  tr: {
    ...
    market: {
      ...
      autoTrade: {
        ...
        description:
          "Fiyat belirlediğin eşiği geçtiğinde otomatik alım/satım yap. Kural aktif kaldığı sürece, koşul her turda geçerliyse tekrar tetiklenir.",
  ...
  en: {
    ...
    market: {
      ...
      autoTrade: {
        ...
        description:
          "Automatically buy or sell once a good's price crosses a threshold you set. While a rule stays active, it re-fires every turn its condition still holds.",
