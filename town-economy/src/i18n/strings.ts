export const STRINGS = {
  tr: {
    ...
    mentor: {
      ...
      buy: "Almak tek dokunuş. Gerisini karartıyorum, sadece şu buton çalışıyor.",
      ...
      inflation:
        "Şu sayı kasabanın fiyat endeksi. Her gün biraz yükselir ve kasanda duran para değer kaybeder.",
      inflationTip: "Parayı bekletme, mala çevir.",
      loseTitle: "Nasıl kaybedersin",
      lose: "Oyunun tek kaybetme yolu bu sayı. {limit} rakamına ulaşırsa hiperenflasyon patlar, ekonomi çöker ve kasaba biter.",
      loseTip: "Gözün hep bu sayıda olsun.",
      taxTitle: "Asıl tehlike: vergi",
      tax: "Vergiyi yükseltirsen kasa dolar ama halk mutsuz olur. Mutsuz köylü az üretir; mal azalınca fiyatlar fırlar ve enflasyonu asıl sen körüklersin.",
  ...
  en: {
    ...
    mentor: {
      ...
      buy: "Buying is one tap. I've dimmed the rest — only that button works.",
      buyTip: "Press BUY.",
