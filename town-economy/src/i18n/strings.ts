export const STRINGS = {
  tr: {
    ...
    notif: {
      ...
      unhappyBody: "Vergi oranını düşürmezsen isyan çıkabilir. Kasabana göz at.",
      dailyReminderTitle: "🏘️ Kasaban seni bekliyor",
      dailyReminderBody: "Günlük bonusunu almayı ve piyasayı kontrol etmeyi unutma!",
    },
    good: {
  ...
  en: {
    ...
    notif: {
      ...
      unhappyBody: "Lower the tax rate or a revolt could break out. Check on your town.",
      dailyReminderTitle: "🏘️ Your town is waiting",
      dailyReminderBody: "Don't forget to grab your daily bonus and check the market!",
    },
    good: {
