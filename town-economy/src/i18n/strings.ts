export const STRINGS = {
  tr: {
    ...
    town: {
      ...
      bank: {
        title: "🏦 Banka",
        description: "Kasaya kredi çek, karşılığında faiz birikir. Banka geliştirmesi faiz oranını düşürür.",
  ...
  en: {
    ...
    town: {
      ...
      bank: {
        title: "🏦 Bank",
        description: "Borrow against the treasury; interest accrues over time. A higher Bank upgrade level buys a cheaper rate.",
        cap: "Max loan: {amount} 🪙",
        takeBtn: "Borrow {amount} 🪙",
        activeTitle: "Outstanding Balance",
        rate: "{pct}%/turn interest",
