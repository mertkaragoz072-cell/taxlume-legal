...
const styles = StyleSheet.create({
  ...
  footerRow: { flexDirection: "row", justifyContent: "space-between", marginTop: 2, paddingLeft: 22, paddingRight: 22 },
  label: { fontSize: TYPE.micro, fontWeight: WEIGHT.bold, fontFamily: FONT.bold, flex: 1, marginRight: SPACING.sm },
