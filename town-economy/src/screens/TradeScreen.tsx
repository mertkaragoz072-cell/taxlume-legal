...
const styles = StyleSheet.create({
  ...
  lockedProgress: { color: COLORS.accent, fontSize: TYPE.label, fontWeight: WEIGHT.bold },
  metropolLockedCard: {
    flexDirection: "row",
    alignItems: "center",
  ...
  metropolLockedTitle: { color: COLORS.textPrimary, fontWeight: WEIGHT.bold, fontSize: TYPE.body },
  metropolLockedDesc: {
    color: COLORS.textMuted,
  ...
  metropolLockedProgress: { color: COLORS.accent, fontSize: TYPE.caption, fontWeight: WEIGHT.bold },
  ...
  townName: { color: COLORS.textPrimary, fontWeight: WEIGHT.bold, fontSize: TYPE.body },
  ...
  heatmapCellText: { color: COLORS.textPrimary, fontWeight: WEIGHT.bold, fontSize: TYPE.micro },
  ...
  sideBtnText: { color: COLORS.textMuted, fontWeight: WEIGHT.bold, fontSize: TYPE.caption },
  ...
  confirmBtnText: { color: "#fff", fontWeight: WEIGHT.black, fontSize: TYPE.body },
  ...
  caravanTitle: { color: COLORS.textPrimary, fontWeight: WEIGHT.bold, fontSize: TYPE.label },
  caravanEta: { color: COLORS.accent, fontWeight: WEIGHT.bold, fontSize: TYPE.caption },
